...
//                .cornerRadius(25)
            ...
            ExpandButton(id: 3, systemImage: "note.text", action: {}, extraButtons: [("pencil.and.list.clipboard", {fvm.isAnnotationMode.toggle()}), ("books.vertical.fill", {openWindow(id: "NotesWindow")})], expendButton: $fvm.expendButton)
                .help("Notes")
